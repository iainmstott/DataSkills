...
an example of a code chunk below, and its common outputs you'll see in these 
worksheets: a plot, and some text. It's just for you to see what code chunks and 
...
found further down on this page), and interactive 
