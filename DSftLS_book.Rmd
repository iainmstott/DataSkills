...
Code is always written using a `fixed width font` like Courier New, Consolas or 
...
_Code chunks_ are collections of lines of code which do a certain thing. This 
