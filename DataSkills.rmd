...
USING THE [**SHINYGLM APP**](https://iainmstott.shinyapps.io/ShinyGLiM):
...
IN THE [**SHINYGLM APP**](https://iainmstott.shinyapps.io/ShinyGLiM): 
...
Answer the questions below about where the mistakes are found. If you're not sure, then you can always edit the options in the [**ShinyGLM app**](https://iainmstott.shinyapps.io/ShinyGLiM) and compare the code above with the code in the app to spot the differences.  
