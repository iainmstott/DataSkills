...
<center>
![](https://youtu.be/8MuvnkL8kGc){width="80%"}
</center>  
\  
...
<center>
![](https://youtu.be/0PRoKgyshO0){width="80%"}
</center>
\  
...
<center>
![](https://youtu.be/thf9BLJhygo){width="80%"}
</center>
\  
\  
...
<!--
<center>
![](https://youtu.be/L2Mm1sFZoYw){width="80%"}
</center>
\  
-->
...
quiz(caption = "**< QUIZ 2 >** Data Distributions",
    ...
    question("Is the 'countries' variable continuous or discrete?",
